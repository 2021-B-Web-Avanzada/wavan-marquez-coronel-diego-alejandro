...
exports.showAStoreById = exports.showStores = void 0;
...
const showStores = () => __awaiter(void 0, void 0, void 0, function* () {
    const stores = yield elect_store_controller_1.default.getAllStores();
    stores.map(store => {
        console.log((0, update_elect_store_1.setFormatStore)(store));
    });
});
exports.showStores = showStores;
const showAStoreById = () => __awaiter(void 0, void 0, void 0, function* () {
    const stores = yield elect_store_controller_1.default.getAllStores();
    ...
    return (0, update_elect_store_1.setFormatStore)(store);
});
exports.showAStoreById = showAStoreById;
